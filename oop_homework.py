...
stud_one = Student('Ivan', 'Ivanov', 'Man')
stud_one.finished_courses = ['Введение в программирование']
stud_one.courses_in_progress = ['Python', 'Git']
stud_two = Student('Egor', 'Egorov', 'Man')
stud_two.finished_courses = ['Введение в программирование']
stud_two.courses_in_progress = ['Python', 'Git']

lect_one = Lecturer('Peter', 'Petrov')
lect_one.courses_attached = ['Python']
lect_two = Lecturer('Serge', 'Sergeev')
lect_two.courses_attached = ['Git']

rev_one = Reviewer('Roman', 'Romanov')
rev_one.courses_attached = ['Python']
rev_two = Reviewer('Artem', 'Artemov')
rev_two.courses_attached = ['Git']

rev_one.rate_hw(stud_one, 'Python', 9)
rev_one.rate_hw(stud_two, 'Python', 7)
rev_two.rate_hw(stud_one, 'Git', 8)
rev_two.rate_hw(stud_two, 'Git', 6)

stud_one.rate_lecturer(lect_one, 'Python', 9)
stud_one.rate_lecturer(lect_two, 'Git', 6)
stud_two.rate_lecturer(lect_one, 'Python', 7)
stud_two.rate_lecturer(lect_two, 'Git', 9)
